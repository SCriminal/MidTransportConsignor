...
+(void)requestBulkCargoOrderListWithwaybillStates:(NSString *)waybillStates
    ...
    [self getUrl:@"/zhongcheyun/bulkcargo/waybill/list/2/10/total" delegate:delegate parameters:dic success:success failure:failure];
}
...
+(void)requestBulkCargoDetailWithId:(NSString *)identity
    ...
    [self getUrl:@"/zhongcheyun/bulkcargo/waybill/1_0_10/shipper/10/{id}" delegate:delegate parameters:dic success:success failure:failure];
}
