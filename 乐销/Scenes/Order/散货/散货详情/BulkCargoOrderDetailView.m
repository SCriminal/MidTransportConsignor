...
//                ModelBtn * model = [ModelBtn new];
//                model.title = @"车        型：";
//                model.subTitle = [NSString stringWithFormat:@"%@",[GlobalMethod exchangeCarType:modelCargo.vehicleType]];
//                return model;
//            }()];
...
- (void)resetViewWithModel:(ModelBulkCargoOrder *)model{
    ...
    [self.labelName fitTitle:[NSString stringWithFormat:@"%@%@",UnPackStr(model.driverName),strTruckNum] variable:0];
