...
- (void)registAuthorityCell{
    ...
    [self.tableView registerClass:[PerfectTextViewCell class] forCellReuseIdentifier:@"PerfectTextViewCell"];
...
- (UITableViewCell *)dequeueAuthorityCell:(NSIndexPath *)indexPath{
    ...
    switch (model.enumType) {
        case ENUM_PERFECT_CELL_TEXT:
        {
            ...
            break;
        case ENUM_PERFECT_CELL_TEXTVIEW:
        {
            PerfectTextViewCell * textCell = [self.tableView dequeueReusableCellWithIdentifier:@"PerfectTextViewCell"];
            [textCell resetCellWithModel:model];
            return textCell;
        }
            break;
...
- (CGFloat)fetchAuthorityCellHeight:(NSIndexPath *)indexPath{
    ...
    switch (model.enumType) {
        ...
        case ENUM_PERFECT_CELL_TEXTVIEW:
        {
            return [PerfectTextViewCell fetchHeight:model];
        }
            break;
        case ENUM_PERFECT_CELL_SELECT:
        {
