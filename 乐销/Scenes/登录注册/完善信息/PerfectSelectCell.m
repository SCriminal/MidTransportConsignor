...
- (void)resetCellWithModel:(ModelBaseData *)model{
    ...
    [self.title fitTitle:model.string variable:W(99)];
    ...
    [self.subTitle fitTitle:isStr(model.subString)?model.subString:placeHolder variable:(self.iconArrow.hidden?SCREEN_WIDTH:self.iconArrow.left) - W(99) - W(10)];
