...
- (void)timerRun{
    ...
    if (_numTime <=0) {
        ...
        self.labelResend.textColor = COLOR_ORANGE;
...
- (void)resetViewWithModel:(id)model{
    ...
    for (int i = 0; i<6; i++) {
        ...
        labelShow.textColor = COLOR_ORANGE;
...
- (void)textChange{
    ...
    for (int i = 0; i<6; i++) {
        ...
        [GlobalMethod setRoundView:viewLine color:str.length >= i+1?COLOR_ORANGE:COLOR_LINE numRound:5 width:1];
    }
