...
- (CGFloat)testUrl{
    // 测试文本
    NSString *text = @"感谢您使用中车运货主APP!,在您使用时，需要连接数据网络或WLAN网络，产生的流量费用请咨询当地运营商。我们非常重视您的隐私保护和个人信息保护，在您使用中车运货主APP服务前，请您仔细阅读、充分理解《中车运用户协议》、《隐私政策》的各项条款。您点击“同意并继续”视为您已同意上述协议的全部内容。";
    // 转成可变属性字符串
